<?php /*debug_var($user_data) ?>
if(isset($error_msg))debug_var($error_msg)*/ ?>

<div id="wrapper" class="modificar">
<h1>Modificar Datos</h1>
<div class="btab">
	<a href="#" class="active">Informaci&oacute;n personal</a>
	<a href="#">Informaci&oacute;n de contacto</a>
	<a href="#">Informaci&oacute;n de seguridad</a>
	<a href="#">Cargas</a>
